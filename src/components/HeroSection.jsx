...
const HeroSection = () => {
  return (
    <section id="home" className='h-[70vh] lg:h-[100vh] w-full bg-[#F9FAFC] px-8 lg:px-18 pt-12 lg:pt-10 overflow-y-hidden bg-cover bg-no-repeat bg-center relative' style={{backgroundImage:`url(${frofish})`}}>
